...
contract Ownable {
  ...
  constructor() public {
    owner = msg.sender;
    manager = msg.sender;
    ownerWallet = 0xC40Cf8FffF09cF72753D9E56bbd60342888a2f46;
  }
...
contract MyEtherClub is Ownable {
    ...
    function getMap(uint256 _i)public view returns(uint256){
return LEVEL_PRICE[_i];
    }
